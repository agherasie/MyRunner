...
{
    g.bgm[0] = sfMusic_createFromFile("art/sound/rooftoprun.ogg");
    g.bgm[1] = sfMusic_createFromFile("art/sound/iceparadise.ogg");
    g.bgm[2] = sfMusic_createFromFile("art/sound/gangstasparadise.ogg");
    for (int i = 0; i < 3; i++)
        sfMusic_setLoop(g.bgm[i], sfTrue);
    g.title_music = sfMusic_createFromFile("art/sound/title-theme.ogg");
    g.finish_music = sfMusic_createFromFile("art/sound/stage-clear.ogg");
    g.boss_music = sfMusic_createFromFile("art/sound/title-theme.ogg");
